...
class UserProfileAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance and self.instance.pk:
            self.initial['dietary_restrictions'] = self.instance.dietary_restrictions or []
...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ['user', 'sex', 'goal', 'activity_level', 'current_weight', 'tdee', 'recommended_calories']
    readonly_fields = ['age', 'current_weight', 'bmr', 'tdee', 'recommended_calories', 'recommended_macros', 'created_at', 'updated_at']
